...
{
    /// <summary>
    /// Provides the implementation for wrting the entity records to a data store in clear text, but 
    /// in a binary format.
    /// </summary>
    /// <seealso cref="ExceptionTrackingBase" />
    /// <seealso cref="IEntityWriter" />
    public sealed class ClearEntityWriter : ExceptionTrackingBase, IEntityWriter
    {
        ...
        /// The writer instance.
        /// </summary>
        private ClearSafeWriter? _writer;
        #endregion
        ...
        /// </summary>
        /// <param name="fileName">
        /// A string containing the fully-qualified name and path of the file to be created.
        /// </param>
        public ClearEntityWriter(Stream destinationStream)
        {
            _stream = destinationStream;
            _writer = new ClearSafeWriter(_stream);
        }
		/// <summary>
