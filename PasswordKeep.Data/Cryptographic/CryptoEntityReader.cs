...
namespace PasswordKeep.Data
{
	...
	public sealed class CryptoEntityReader : ExceptionTrackingBase, IEntityReader
	{
		#region Private Member Declarations        
		/// <summary>
		/// The reader instance.
		/// </summary>
		private CryptoSafeReader? _reader;
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CryptoEntityReader"/> class.
		/// </summary>
		/// <param name="sourceStream">
		/// The reference to the source <see cref="Stream"/> to be read from.
		/// </param>
		public CryptoEntityReader(Stream sourceStream, string userId, string filePassword)
		{
			_stream = sourceStream;
			OpenFileForReading(userId, filePassword);
		}
		/// <summary>
		...
		/// <b>true</b> if the operation is successful; otherwise, returns <b>false</b>.
		/// </returns>
		private bool OpenFileForReading(string userId, string filePassword)
		{
			bool success = false;
			...
			if (_stream != null)
			{
				...
				else
				{
					...
					try
					{
						_reader = new CryptoSafeReader(_stream, userId, filePassword);
						success = true;
					}
					catch (Exception ex)
					{
