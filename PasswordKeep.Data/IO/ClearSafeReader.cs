...
{
    /// <summary>
    /// Provides an implementation for reading the Password Keep entities to a stream as clear text, but 
    /// in a binary format.
    /// </summary>
    /// <seealso cref="ExceptionTrackingBase" />
    /// <seealso cref="ISafeReader" />
    public sealed class ClearSafeReader : ExceptionTrackingBase, ISafeReader
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearSafeReader"/> class.
        /// </summary>
        /// <param name="sourceStream">
        /// The reference to the destination <see cref="Stream"/> to be read from.
        /// </param>
        public ClearSafeReader(Stream sourceStream)
        {
