...
{
    /// <summary>
    /// Provides an implementation for writing the Password Keep data fields to a stream as clear text, but 
    /// in a binary format.
    /// </summary>
    /// <seealso cref="ExceptionTrackingBase" />
    /// <seealso cref="ISafeWriter" />
    public sealed class ClearSafeWriter : ExceptionTrackingBase, ISafeWriter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearSafeWriter"/> class.
        /// </summary>
        /// <param name="destinationStream">
        /// The reference to the destination <see cref="Stream"/> to be written to.
        /// </param>
        public ClearSafeWriter(Stream destinationStream)
        {
            _streamReference = destinationStream;
            _writer = new BinaryWriter(destinationStream);
        }
        /// <summary>
