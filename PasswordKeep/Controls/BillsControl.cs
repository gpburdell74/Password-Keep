...
{
	/// <summary>
	/// Provides the UI grid control for viewing and editing the Bill entries.
	/// </summary>
	/// <seealso cref="AdaptiveControlBase" />
	public partial class BillsControl : AdaptiveControlBase
    {
		...
		/// The data content.
		/// </summary>
		private BillCollection? _data;
		#endregion

		#region Constructor / Dispose Methods        
		/// <summary>
		/// Initializes a new instance of the <see cref="BillsControl"/> class.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <value>
		/// The <see cref="BillCollection"/> instance containing the data for the data source.
		/// </value>
		public BillCollection? DataSource
        {
			get
			{
				return _data;
