...
{
	/// <summary>
	/// Provides the UI grid control for viewing and editing the Identity Provider entries.
	/// </summary>
	/// <seealso cref="AdaptiveControlBase" />
	public partial class IdProviderControl : AdaptiveControlBase
    {
		...
		/// The data content.
		/// </summary>
		private IdentityProviderCollection? _data;
		#endregion

		#region Constructor / Dispose Methods        
		/// <summary>
		/// Initializes a new instance of the <see cref="IdProviderControl"/> class.
		/// </summary>
		/// <remarks>
		/// This is the default constructor.
		/// </remarks>
		public IdProviderControl()
        {
            InitializeComponent();
        }
        /// <summary> 
		...
		/// </summary>
		/// <value>
		/// The <see cref="IdentityProviderCollection"/> instance containing the data for the data source.
		/// </value>
		public IdentityProviderCollection? DataSource
        {
            get
            {
                return _data;
		...
		{
			IdServiceCol.DataSource = new IdentityServiceSelectionList();
		...
		private static void StartBrowser(string url)
		{
			...
			{
				System.Diagnostics.Process.Start(explorerPath, url);
			}
			catch (Exception ex)
			{
