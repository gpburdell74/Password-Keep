...
{
	/// <summary>
	/// Provides the UI grid control for viewing and editing the Financial account entries.
	/// </summary>
	/// <seealso cref="AdaptiveControlBase" />
	public partial class FinancialAccountControl : AdaptiveControlBase
    {
		...
		/// The data content.
		/// </summary>
		private FinancialAccountCollection? _data;
		#endregion

		#region Constructor / Dispose Methods        
		/// <summary>
		/// Initializes a new instance of the <see cref="FinancialAccountControl"/> class.
		/// </summary>
		/// <remarks>
		/// This is the default constructor.
		/// </remarks>
		public FinancialAccountControl()
        {
            InitializeComponent();
        }
		/// <summary> 
		...
		/// </summary>
		/// <value>
		/// The <see cref="FinancialAccountCollection"/> instance containing the data for the data source.
		/// </value>
		public FinancialAccountCollection? DataSource
        {
			get
			{
				return _data;
		...
		{
			AccountTypeCol.DataSource = new FinancialAccountTypeSelectionList();
			AccountTypeCol.DisplayMember = "Name";
			AccountTypeCol.ValueMember = "AccountType";
		}
		/// <summary>
